...
<html>
<style>
    .product-image-wrapper :hover .baseImage {
...
<div class="col-sm-9 padding-right">
    <div class="features_items"><!--features_items-->
        ...
        <c:forEach var="product" items="${model}">
            <c:if test="${not empty product.baseImage}">
                <div class="col-sm-4">
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <c:url var="productDetailUrl" value="/product-detail">
                                    <c:param name="p" value="${product.productName}"/>
                                    <c:param name="i" value="${product.ID}"/>
                                </c:url>
                                <a href="${productDetailUrl}"><img
                                        src="<c:url value="/templates/images/product-details/${product.baseImage}"/>"
                                        class="baseImage"></a>
